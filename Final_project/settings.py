...
ALL_COLORS_DICT = {
    (0.8, 1.0, 1.0, 1.0),  # white-ish
    (0.6, 0.3, 1.0, 1.0),  # light purple
    (0.2, 0.1, 1.0, 1.0),  # Dark blue
    (0.0, 1.0, 0.0, 1.0),  # Green
    (1.0, 1.0, 0.0, 1.0),  # Yellow
    (1.0, 0.0, 0.0, 1.0),  # Red
    (0.0, 1.0, 0.6, 1.0),  # Aqua green blue
    (0.9, 0.6, 0.3, 1.0),  # Orange
    (1.0, 0.4, 1.0, 1.0)  # Pink
}

COLOR_DICT = {
    "vlow": {
        "id": 0,
        "color": (0.8, 1.0, 1.0, 1.0)  # white-ish
    },
    "vmedium": {
        "id": 1,
